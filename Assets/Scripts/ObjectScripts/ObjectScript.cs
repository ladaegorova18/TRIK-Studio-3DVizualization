...
/// </summary>
public class ObjectScript : DraggableObject
{
	...
	private IEnumerator ReadLine(string line)
	{
...
protected virtual IEnumerator Move(string data)
	...
	/// <summary>
	/// Do not let user change size of robot, balls and skittles, because we want to keep TRIK Studio proportions
	/// </summary>
